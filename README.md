...
🔹 **Backend Developer** with diverse experience in IT:  
- Developing **landing pages**, **portals**, **SSR & SPA applications**, **mobile apps**, and **Telegram bots** (one of them has **30,000+ active users**)  
- Experience in both **small teams** and **large companies**, including **government projects** in Belarus and Russia  
- Participation in a **hackathon-winning team**, where we created and sold a mobile app  
- Worked on a **global portal for a major Chinese car manufacturer**, automating dealer processes worldwide  
- Skilled in **legacy projects & high-load systems optimization** (e.g., PostgreSQL partitioning, DB restructuring, **90% faster server response**)  
- **Team leadership experience** – coordinated a Python team developing an AI chatbot for AMD  
